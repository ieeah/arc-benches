...
## Decisione
Rimuovere il middleware `persist` nativo e adottare una gestione esplicita con salvataggi mirati (`save()`) e try/catch isolato nel wrapper [safeStorage.ts](../../src/lib/safeStorage.ts) (`safeLS`).
