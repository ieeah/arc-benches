# VERSIONING.md — Piano delle Versioni

Piano previsionale delle versioni verso l'MVP (1.0.0) e oltre, basato sui task presenti in [1_CURRENT.md](1_CURRENT.md), [2_ROADMAP.md](2_ROADMAP.md) e [3_BACKLOG.md](3_BACKLOG.md) al momento della stesura. Non è un registro storico — per quello, vedi i tag Git e i rilascio changelog.
...
## 0.3.0 — Roleplay & Refactoring Architetturale — Parziale
...
## 0.4.0 — Spedizioni, Progetti & UX Tastiera — Non ancora raggiunta
- **Spedizioni & Progetti (Fase 3)** (→ [2_ROADMAP.md](2_ROADMAP.md))
- **Tieni o Butta — Indicatore "Non Vendere" (Fase 3)** (→ [2_ROADMAP.md](2_ROADMAP.md) / [tieni-o-butta.md](specs/tieni-o-butta.md))
- **Supporto Tastiera per Drag & Drop** (→ [3_BACKLOG.md](3_BACKLOG.md))
- **Revisione Ordine Menu FloatingNav** (→ [3_BACKLOG.md](3_BACKLOG.md))

---

## 0.5.0 — Sharing, Biografie & Tooling Community — Non ancora raggiunta
...
## 1.0.0 — MVP Completo & Sync Cloud Supabase — Non ancora raggiunta
- **Supabase — Schema Dati di Gioco (Fase 2a)** (→ [2_ROADMAP.md](2_ROADMAP.md))
- **Supabase — Account & Auth Opt-in (Fase 2b)** (→ [2_ROADMAP.md](2_ROADMAP.md))
- **Supabase — Sync Background Offline-First (Fase 2c)** (→ [2_ROADMAP.md](2_ROADMAP.md))
- **Validazione Runtime Schemi Leggera** (→ [3_BACKLOG.md](3_BACKLOG.md))
