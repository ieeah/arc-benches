...
Piano previsionale delle versioni verso l'MVP (1.0.0) e oltre, basato sui task presenti in [2_ROADMAP.md](2_ROADMAP.md) e [3_BACKLOG.md](3_BACKLOG.md) al momento della stesura.
...
## Tema dei nickname
*Fasi di Sopravvivenza & Ricostruzione del Rifugio (ARC Raiders)* - I nickname seguono l'evoluzione narrativa del rifugio dei Raiders in Speranza, coerente con l'ambientazione e le fasi di progressione del gioco.
...
## 0.2.0 "Sacca dei Materiali" — Multi-Profilo & UX Mobile-First — Parziale
...
- Accessibilità Overlay Legacy & Controlli (→ [3_BACKLOG.md](3_BACKLOG.md))
...
- Role Maker — Randomizer di Personalità (Fase 3) (→ [2_ROADMAP.md](2_ROADMAP.md))
...
- Tieni o Butta — Indicatore "Non Vendere" (Fase 3) (→ [2_ROADMAP.md](2_ROADMAP.md))
...
- Condivisione Lista tramite Link (Fase 3) (→ [2_ROADMAP.md](2_ROADMAP.md))
